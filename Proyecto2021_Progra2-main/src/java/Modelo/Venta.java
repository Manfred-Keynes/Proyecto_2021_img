 ...
 */
public class Venta {
    private int id,nFactura,id_cliente,id_empleado;
    Conexion cn;

    public Venta(){}
    public Venta(int id, int nFactura, int id_cliente, int id_empleado) {
        this.id = id;
    ...
    public DefaultTableModel leer() {
        ...
        try{
            ...
            cn = new Conexion();
            cn.abrir_conexion();
            query = "SELECT idVentas as id,v.noFactura, v.serie, v.fechaFactura, c.nit, c.nombres, c.apellidos, e.nombres, e.apellidos, c.idClientes, e.idempleados FROM ventas AS v INNER JOIN empleados AS e ON e.idempleados = v.idempleado INNER JOIN clientes AS c ON c.idClientes = v.idcliente order by idVentas;";
